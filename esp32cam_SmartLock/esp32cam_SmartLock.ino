...
HardwareSerial SerialPort(2); // UART1 (GPIO17 TX, GPIO16 RX)
...
void setup() {
  Serial.begin(115200);
 SerialPort.begin(9600, SERIAL_8N2, 3, 1); // UART2, RX=3, TX=1
...
//init with high specs to pre-allocate larger buffers
  ...
  // Gửi địa chỉ IP qua UART
  SerialPort.println(ipAddress);
  Serial.println("Sent IP: " + ipAddress);
